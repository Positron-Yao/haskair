...
/* package haskair-0.1.0.0 */
#ifndef VERSION_haskair
#define VERSION_haskair "0.1.0.0"
#endif /* VERSION_haskair */
#ifndef MIN_VERSION_haskair
#define MIN_VERSION_haskair(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskair-0.1.0.0-inplace-haskair"
